---
title: "Plot the distribution of vertex degree"
author: "Shaun Jackmn"
params:
  input_tsv:
    label: "Input TSV file"
    value: "physlr.overlap.mol.deg.tsv"
    input: text
---
...
# Read data
```{r read}
graph <- read_tsv(input_tsv, col_types = "--i")
```

# Boxplot statistics
```{r boxplot-statistics}
quartiles <- boxplot.stats(graph$Degree)$stats
